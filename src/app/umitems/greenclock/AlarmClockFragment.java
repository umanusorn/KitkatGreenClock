...
import app.umitems.greenclock.provider.DaysOfWeek;
import app.umitems.greenclock.widget.ActionableToastBar;
import app.umitems.greenclock.widget.TextTime;
	    ...
	    void bindView(final View view, Context context, final Cursor cursor) {
		    ...
		    itemHolder.delete.setOnClickListener(new View.OnClickListener() {
			    ...
			    void onClick(View v) {
				    ...
				    view.animate().setDuration(ANIMATION_DURATION).alpha(0).translationY(-1).withEndAction(
						    new Runnable() {
