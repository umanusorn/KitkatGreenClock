...
/**
 * Class to measure and draw the time in the {@link app.umitems.greenclock.CircleTimerView}.
...
public class CountingTimerView extends View {
     ...
     * {@link app.umitems.greenclock.CircleTimerView#onDraw(android.graphics.Canvas)}
     */
